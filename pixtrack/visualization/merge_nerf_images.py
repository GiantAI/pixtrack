...
def merge_images(images1, images2):
    ...
    for image_number in range(len(images1)):
        ...
        merged_images.append(
            np.maximum(images1[image_number], images2[image_number]).astype(np.uint8)
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("one", type=str, help="first nerf path")
    parser.add_argument("two", type=str, help="second nerf path")
    parser.add_argument("three", type=str, default=None, help="third nerf path")
