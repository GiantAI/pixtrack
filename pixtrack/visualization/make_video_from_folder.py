...
if __name__ == "__main__":
    ...
    parser.add_argument("input_folder_path", type=str, help="first nerf path")
    parser.add_argument("output_folder_path", type=str, help="first nerf path")

    args = parser.parse_args()
    images1 = read_images_from_folder_2(args.input_folder_path)
    mediapy.write_video(
        os.path.join(args.output_folder_path, "overlay.mp4"), images1, fps=240
    )
